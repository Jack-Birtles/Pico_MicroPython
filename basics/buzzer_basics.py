...
tones = {"B0": 31, "C1": 33, "CS1": 35, "D1": 37, "DS1": 39, "E1": 41, "F1": 44, "FS1": 46, "G1": 49,
         ...
         "D3": 147, "DS3": 156, "E3": 165, "F3": 175, "FS3": 185, "G3": 196, "GS3": 208, "A3": 220,
         "AS3": 233, "B3": 247, "C4": 262, "CS4": 277, "D4": 294, "DS4": 311, "E4": 330, "F4": 349,
         "FS4": 370, "G4": 392, "GS4": 415, "A4": 440, "AS4": 466, "B4": 494, "C5": 523, "CS5": 554,
         "D5": 587, "DS5": 622, "E5": 659, "F5": 698, "FS5": 740, "G5": 784, "GS5": 831, "A5": 880,
...
def play_song(my_song, my_durations):
    for i in range(len(my_song)):
        if (my_song[i] == "P"):
            be_quiet()
        else:
            play_tone(tones[my_song[i]])
        time = 1000 / my_durations[i]
        pause = time * 1.05
        sleep(time)
        be_quiet()
        sleep(pause)
...
song = ["D4", "D4", "D4", "D4", "D4", "D4", "D4", "D4", "D4", "D4", "D4", "D4",
        "D4", "D4", "D4", "D4", "D4", "D4", "D4", "D4", "D4", "D4", "D4", "D4",
        "A3", "C4", "D4", "D4", "D4", "E4", "F4", "F4", "F4", "G4", "E4", "E4",
        "D4", "C4", "D4", "P", "A3", "C4", "B3", "D4", "B3", "E4", "F4", "F4",
        "C4", "C4", "C4", "C4", "D4", "C4", "D4", "P", "P"]
durations = [4,8,4,8,4,8,8,8,8,4,8,4,8,4,8,8,8,8,4,8,4,8,
